...
每日报告会先给覆盖质量，再给标的速览，最后展开来源和失败原因。下面是 2026-06-06 到 2026-06-15 试跑的节选：
...
周六 A 股周报会读取本周所有 `damo_runs/`，把它压成一个“大摩追踪信号”区块：
...
周日知识沉淀任务再读取 A 股周报和本周大摩结果，沉淀成“本周机构线索 -> 可跟踪标的 -> 需要复核的问题”。
